...
var $author$project$Main$TodosLoaded = function (a) {
	return {$: 'TodosLoaded', a: a};
};
var $author$project$Main$Todo = F3(
	function (id, text, completed) {
		return {completed: completed, id: id, text: text};
	});
...
var $author$project$Main$decodeTodo = A4(
...
var $author$project$Main$decodeTodos = $elm$json$Json$Decode$list($author$project$Main$decodeTodo);
var $elm$json$Json$Decode$decodeValue = _Json_run;
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$Main$loadTodos = _Platform_incomingPort('loadTodos', $elm$json$Json$Decode$value);
var $author$project$Main$subscriptions = function (_v0) {
	return $author$project$Main$loadTodos(
		function (value) {
			var _v1 = A2($elm$json$Json$Decode$decodeValue, $author$project$Main$decodeTodos, value);
			if (_v1.$ === 'Ok') {
				var todos = _v1.a;
				return $author$project$Main$TodosLoaded(todos);
			} else {
				return $author$project$Main$TodosLoaded(_List_Nil);
			}
		});
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'id',
				$elm$json$Json$Encode$int(todo.id)),
				_Utils_Tuple2(
				'text',
				$elm$json$Json$Encode$string(todo.text)),
				_Utils_Tuple2(
				'completed',
				$elm$json$Json$Encode$bool(todo.completed))
			]));
};
...
var $author$project$Main$encodeTodos = function (todos) {
	return A2($elm$json$Json$Encode$list, $author$project$Main$encodeTodo, todos);
};
...
var $author$project$Main$saveTodos = _Platform_outgoingPort('saveTodos', $elm$core$Basics$identity);
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'AddTodo':
				...
				var newTodo = {completed: false, id: newId, text: model.input};
				...
				return _Utils_Tuple2(
					newModel,
					$author$project$Main$saveTodos(
						$author$project$Main$encodeTodos(newModel.todos)));
			case 'ToggleTodo':
				var index = msg.a;
				...
				var newModel = _Utils_update(
					model,
					{
						todos: A2($elm$core$List$map, toggle, model.todos)
					});
				return _Utils_Tuple2(
					newModel,
					$author$project$Main$saveTodos(
